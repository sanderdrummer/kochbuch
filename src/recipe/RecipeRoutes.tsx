...
import { IconLink } from '@kochbuch/components'
...
export const RecipeRoutes = () => {
  return (
    <>
      <Route path="/recipes">
        <Route path="/" component={RecipesView} />
        <Route path="/:id" component={RecipeDetailsView} />
      </Route>
      <Route path="/plan">
        <Route path="/" component={PlanView} />
        <Route path="/:id" component={PlanDetailsView} />
      </Route>
